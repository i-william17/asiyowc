                    ...
                    <View style={[
                        ...
                        <View style={tw`flex-row justify-between mt-2 px-2`}>
                            {[1, 2, 3].map((step, index) => {
                                ...
                                return (
                                    <View key={step} style={tw`flex-1 items-center relative`}>
                                        {/* STEP CIRCLE */}
                                        <View
                                            style={[
                                                tw`w-8 h-8 rounded-full items-center justify-center z-10`,
                                                active
                                        ...
                                        {step !== 3 && (
                                            <View
                                                style={{
                                                    ...
                                                    top: 16,
                                                    height: 2,
                                                    backgroundColor: activeStep > step ? "#6A1B9A" : "#E5E7EB",
                                                }}
                                            />
                                        )}
                                        ...
                                        <Text
                                            style={{
                                                ...
                                                color: activeStep === step ? "#6A1B9A" : "#9CA3AF",
                                                fontSize: 11,
                                                marginTop: 8,
                                                textAlign: 'center'
                                            }}
                                    ...
                                    <View style={tw`mb-6`}>
                                        ...
                                        <View>
                                            ...
                                            <TextInput
                                                ...
                                                onFocus={() => scrollRef.current?.scrollTo({ y: 500, animated: true })}
                                                style={enhancedInputStyle}
                                            />
                                            {form.deadline && (
                                                <Text style={{
                                ...
                                <View>
                                    ...
                                    <View style={[
                                        ...
                                        <Text style={[tw`text-sm`, { fontFamily: "Poppins-Regular", color: "#92400E" }]}>
                                            {`You're creating a ${form.privacy === 'public' ? 'public' : form.privacy === 'private' ? 'private' : 'invite-only'} savings pod to save KES ${Number(form.targetAmount).toLocaleString()}${form.deadline ? ` by ${form.deadline}` : ' with no set deadline'}`}
                                        </Text>
                                    </View>
